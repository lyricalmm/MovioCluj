      ...
      <div className="bp-container">
        ...
        <header className="bp-hero">
          ...
          <div className="bp-hero-stats">
            ...
            <div className="bp-hero-sep" />
            <div className="bp-hero-stat"><span className="bp-hero-stat-num amber">19.300€</span><span className="bp-hero-stat-label">Finanțare solicitată</span></div>
            <div className="bp-hero-sep" />
        ...
        <section className="bp-section" id="strategie">
          ...
          <div className="bp-grid-4">
            <div className="bp-stat-card"><div className="bp-stat">~19.300€</div><div className="bp-stat-label">Total necesar pilot</div></div>
            <div className="bp-stat-card"><div className="bp-stat">53%</div><div className="bp-stat-label">Biciclete (32 buc)</div></div>
            <div className="bp-stat-card"><div className="bp-stat">11%</div><div className="bp-stat-label">Operare 6 luni</div></div>
        ...
        <section className="bp-section" id="roadmap">
          ...
          <div className="bp-timeline">
            <div className="bp-tl-item"><div className="bp-tl-period">LUNILE 1–3 · Q3 2026</div><div className="bp-tl-title">Lansare Pilot UTCN</div><ul className="bp-tl-items"><li>Finalizare prototip hardware funcțional</li><li>Semnare LOI cu UTCN, înregistrare SRL</li><li>Achiziție 32 biciclete + asamblare 4 hub-uri</li><li>Lansare oficială în campus</li><li>Țintă: 200 abonamente plătite în primele 30 zile</li></ul></div>
        ...
        <section className="bp-section" id="capex">
          <h2 className="bp-section-title"><TrendingUp size={20} /> CAPEX: Investiția Inițială (4 hub-uri × 8 biciclete = 32 biciclete)</h2>
          <div className="bp-table-wrapper">
            <table className="bp-table">
              ...
              <tbody>
                ...
                <tr><td>Componente electronice hub (ESP8266, SG90, limitator, LED, fire)</td><td>4 hub-uri</td><td>100 RON/hub</td><td>400 RON</td></tr>
                <tr><td>Materiale structură hub (profil oțel, vopsit, șuruburi, suport)</td><td>4 hub-uri</td><td>250 RON/hub</td><td>1.000 RON</td></tr>
                <tr><td>Imprimare 3D componente custom (filament PETG, lab UTCN)</td><td>4 hub-uri</td><td>80 RON/hub</td><td>320 RON</td></tr>
                <tr><td>Panouri solare 5V/1W per hub</td><td>4 buc</td><td>35 RON</td><td>140 RON</td></tr>
                <tr><td>Baterie LiPo + modul TP4056</td><td>4 buc</td><td>45 RON</td><td>180 RON</td></tr>
                <tr><td>Coduri QR laminate</td><td>8 buc</td><td>5 RON</td><td>40 RON</td></tr>
                ...
                <tr><td>Rezervă operațională (15%)</td><td>—</td><td>—</td><td>9.766 RON</td></tr>
                <tr className="total-row"><td><strong>TOTAL CAPEX</strong></td><td></td><td></td><td><strong>74.876 RON (~14.975 EUR)</strong></td></tr>
                <tr><td>Mentenanță & operare 6 luni post-lansare</td><td></td><td></td><td>21.630 RON</td></tr>
                <tr className="total-row"><td><strong>TOTAL INVESTIȚIE NECESARĂ</strong></td><td></td><td></td><td><strong className="bp-teal">96.506 RON (~19.301 EUR)</strong></td></tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="bp-section" id="breakeven">
          ...
          <div className="bp-table-wrapper">
            <table className="bp-table">
              ...
              <tbody>
                <tr><td>Investiție inițială</td><td className="negative">~14.000.000 RON (public)</td><td className="positive">~92.770 RON (privat)</td></tr>
                <tr><td>Cost per stație/hub</td><td className="negative">~280.000 RON</td><td className="positive">~625 RON</td></tr>
